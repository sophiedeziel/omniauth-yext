...
Gem::Specification.new do |spec|
  spec.name          = "omniauth-yext"
  spec.version       = Omniauth::Yext::VERSION
  spec.authors       = ["Sophie Déziel"]
  spec.email         = ["courrier@sophiedeziel.com"]

  spec.summary       = %q{Omniauth strategy for Yext}
  spec.homepage      = "http://github.com/sophiedeziel/omniauth-yext"
  spec.license       = "MIT"
